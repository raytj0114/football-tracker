...
const errorMessages: Record<string, string> = {
  OAuthSignin: 'OAuth認証の開始に問題が発生しました',
  OAuthCallback: 'OAuth認証中にエラーが発生しました',
        ...
        <CardContent className="space-y-4 pt-6">
          ...
          <form action={signInWithGoogle}>
            ...
            <Button
              type="submit"
              variant="outline"
              className="w-full h-12 gap-3 border-border/50 bg-background/50 hover:bg-background transition-colors"
            >
